...
public class DoctorController {
	...
	public ResponseEntity<Doctor> findDoctortByName(@PathVariable String name) throws invalidDoctorIdExection {
		Doctor doctor = doctorServices.findDoctorsbyName(name);
		ResponseEntity<Doctor> responseEntity = new ResponseEntity<>(doctor, HttpStatus.FOUND);
		return responseEntity;
	}
