...
<body>
      ...
      <table border='1'>
          ...
          <c:forEach items="${jewlist }" var="jewellery">
          <tr>
           ...
           <td>${jewellery.getType()}</td>
            ...
            <td><a href='editjewellery.jsp?id=${jewellery.getId()}&style=${jewellery.getStyle()}&type=${jewellery.getType()}&weight=${jewellery.getWeight()}&price=${jewellery.getPrice()}&state=${jewellery.getState()}'>Edit</td>
            <td><a href='deletebyid?id=${jewellery.getId()}'>Delete</td>
